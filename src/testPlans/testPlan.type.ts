...
export type TestPlanWriteValues = Omit<TestPlanValues, keyof TestPlanComputedFields>;
...
export type TestPlanCreateResponse = Omit<
	TestPlanValues,
...
export type TestPlanAddCaseResponse = Omit<TestCaseValues, keyof TestCaseComputedFields> & {
	id: number;
	sortkey: number;
};
